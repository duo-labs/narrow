...
if python3 ../../main.py ../projects/simple/main.py --target _checkRequirements; then
...
if python3 ../../main.py ../projects/simple/main.py --target getattr; then
...
if python3 ../../main.py ../projects/simple/main.py --target isLinux; then
